...
namespace WePayApi.Risk.Structure.Rbit
{
    ...
    {
        [JsonIgnore]
        private const string Identifier = "WePayApi.Risk.Structure.Rbit.BusinessNameRbit";
        ...
        public override string Type
        {
            ...
            set
            {
                Type = Common.RbitTypes.BusinessName;
            }
        }
        ...
        /// </summary>
        public new BusinessNameProperties Properties { get; set; }
    }
}